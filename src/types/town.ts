...
export type FacilityStatus='营业中'|'生产中'|'休息中'|'缺少原料'|'员工不足'|'员工未到岗'|'等待顾客'|'等待补货'|'暂停营业'|'住宅'|'开放中'|'缺少电力'|'堆货停工';
...
export interface TownEvent {id:string;type:'rain'|'festival'|'flu'|'drought'|'harvest';title:string;description:string;remaining:number;duration:number}
...
export interface TownState {climate?:import('../systems/climate').Climate}

export interface TownState {hydrology?:import("../systems/hydrology").Hydrology}

export interface TownState {logistics?:import("../systems/logistics").Logistics}
